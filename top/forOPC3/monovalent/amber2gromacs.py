...
# read file
f = open('frcmod.ionslm_126_opc3', 'r')
lines = f.readlines()
f.close()

out = open('top.ionslm_126_opc3', 'w')
...
out.write('Sengupta et al. ion parameters of monovalent ions for OPC3 water model (converted from frcmod style)\n')
for at in atomtypes:
