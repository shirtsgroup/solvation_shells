...
# read file
f = open('frcmod.ions1lm_126_opc', 'r')
lines = f.readlines()
f.close()

out = open('top.ions1lm_126_opc', 'w')
...
out.write('Sengupta et al. ion parameters of monovalent ions for OPC water model (converted from frcmod style)\n')
for at in atomtypes:
