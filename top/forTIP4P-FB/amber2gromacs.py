...
# read file
f = open('frcmod.ionslm_126_fb4', 'r')
lines = f.readlines()
f.close()

out = open('top.ionslm_126_fb4', 'w')
...
out.write('Ion parameters of all ions for TIP4P-FB water model (converted from frcmod style) from Li/Merz groups\n')
for at in atomtypes:
