...
# read file
f = open('frcmod.ions1lm_126_tip3p', 'r')
lines = f.readlines()
f.close()

out = open('top.ions1lm_126_tip3p', 'w')
...
out.write('Ion parameters of all ions for TIP3P-FB water model (converted from frcmod style) from Li/Merz groups\n')
for at in atomtypes:
