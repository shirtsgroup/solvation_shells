...
# read file
f = open('frcmod.ions1lm_126_tip4pew', 'r')
lines = f.readlines()
f.close()

out = open('top.ions1lm_126_tip4pew', 'w')
...
out.write('Ion parameters of all ions for TIP4P-EW water model (converted from frcmod style) from Li/Merz groups\n')
for at in atomtypes:
